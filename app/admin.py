...
class FoodEventsAdmin(admin.ModelAdmin):
...
class FoodRecipesAdmin(admin.ModelAdmin):
...
admin.site.register(FoodEvents, FoodEventsAdmin)
admin.site.register(FoodRecipes, FoodRecipesAdmin)